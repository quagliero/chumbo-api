...
module.exports = (app) => {
  ...
  *           application/json
  */
  app.get('/api/v1/league/:league_id/owners', async (req, res, next) => {
    User.find({
  ...
  *           application/json
  */
  app.get('/api/v1/league/:league_id/owner/:owner_id', async (req, res, next) => {
    User.findOne({
      league_id: req.params.league_id,
  ...
  *           application/json
  */
  app.get('/api/v1/user/:user_id', async (req, res, next) => {
    User.find({
